...
<!-- <button class=" btn  btn-info float-right" onclick="printContent('form')">Print Records</button> -->
        <!-- <div class="myform"> -->
           <div id="form">
             <div class="heading--primary">CAttle records</div>
           ...
           <tr>
               ...
               <td><?php echo $result['shedNo']; ?></td>
                ...
                <td><?php echo($result['breed']) ?></td>
                 ...
                 <td><a href="deleteCattleRecord.php?tag_no=<?php echo $result['Tag_no'] ?>" class="btn btn-danger">Delete</a>
                    <a href="editCattleRecord.php?tag_no=<?php echo $result['Tag_no'] ?>" class="btn btn-info">Edit</a>
                 </td>
